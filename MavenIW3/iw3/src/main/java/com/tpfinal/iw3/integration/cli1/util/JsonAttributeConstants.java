...
public class JsonAttributeConstants {
    ...
    public static final String[] CLIENTE_IDCLI1_ATTRIBUTES = {"id", "id_cli1", "codigo", "code", "codigoCli1"};
    ...
    public static final String[] CHOFER_IDCLI1_ATTRIBUTES = {"id", "id_cli1", "codigo", "code", "codigoCli1"};
    ...
    public static final String[] CAMION_IDCLI1_ATTRIBUTES = {"id", "id_cli1", "codigo", "code", "codigoCli1"};
    public static final String[] CAMION_PATENTE_ATTRIBUTES = {"patente", "licensePlate", "license_plate", "plate"};
    public static final String[] CAMION_DESCRIPCION_ATTRIBUTES = {"descripcion", "description", "desc", "modelo"};

    // Constantes para el nodo Producto
    public static final String[] PRODUCTO_NODE_ATTRIBUTES = {"producto", "product", "combustible", "fuel"};
    public static final String[] PRODUCTO_IDCLI1_ATTRIBUTES = {"id", "id_cli1", "codigo", "code", "codigoCli1"};
    ...
    // Constantes para el nodo Cisterna
    public static final String[] CISTERNA_NODE_ATTRIBUTES = {"cisterna", "tank", "trailer"};
    public static final String[] CISTERNA_IDCLI1_ATTRIBUTES = {"id", "id_cli1", "codigo", "code", "codigoCli1"};
    public static final String[] CISTERNA_CAPACIDAD_ATTRIBUTES = {"capacidad", "capacity", "volumen", "volume"};
}
